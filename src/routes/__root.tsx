...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Asanblé" },
      { name: "description", content: "Booking d'ateliers multi-séances pour centres sociaux en Guadeloupe." },
      { name: "author", content: "Asanblé" },
      { property: "og:title", content: "Asanblé" },
      { property: "og:description", content: "Booking d'ateliers multi-séances pour centres sociaux en Guadeloupe." },
